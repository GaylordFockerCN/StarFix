...
public class Fire_Ball extends NoRenderParticle {
    ...
    public void tick() {
        ...
        for(int i = 0; i < 2; ++i) {
            ...
            for(int l = 0; l < n; ++l) {
                ...
                RenderUtils.AddParticle(this.level, new JCBladeTrail(this.level, this.x, this.y, this.z, (double)direction.x, (double)direction.y, (double)direction.z));
            }
        }
    ...
    @OnlyIn(Dist.CLIENT)
    public static class Provider2 implements ParticleProvider<SimpleParticleType> {
        private final SpriteSet spriteSet;

        public Provider2(SpriteSet spriteSet) {
