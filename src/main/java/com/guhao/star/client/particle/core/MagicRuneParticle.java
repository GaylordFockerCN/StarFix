...
package com.guhao.star.client.particle.core;
...
@OnlyIn(Dist.CLIENT)
public abstract class MagicRuneParticle extends Particle {
    protected float quadSize;

    protected MagicRuneParticle(ClientLevel p_107665_, double p_107666_, double p_107667_, double p_107668_) {
        super(p_107665_, p_107666_, p_107667_, p_107668_);
        this.quadSize = 0.1F * (this.random.nextFloat() * 0.5F + 0.5F) * 2.0F;
    }

    protected MagicRuneParticle(ClientLevel p_107670_, double p_107671_, double p_107672_, double p_107673_, double p_107674_, double p_107675_, double p_107676_) {
