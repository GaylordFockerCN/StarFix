...
public class YamatoSkill extends WeaponInnateSkill {
    ...
    public YamatoSkill(Skill.Builder<? extends Skill> builder) {
        ...
        this.comboAnimation.put(StarAnimations.YAMATO_AUTO1.getRegistryName(), () -> {
            return (AttackAnimation)StarAnimations.YAMATO_POWER1;
        });
        this.comboAnimation.put(StarAnimations.YAMATO_AUTO2.getRegistryName(), () -> {
            return (AttackAnimation)StarAnimations.YAMATO_POWER2;
        });
        this.comboAnimation.put(StarAnimations.YAMATO_AUTO3.getRegistryName(), () -> {
            return (AttackAnimation)StarAnimations.YAMATO_POWER3;
        });
        this.comboAnimation.put(StarAnimations.YAMATO_POWER3.getRegistryName(), () -> {
            return (AttackAnimation)StarAnimations.YAMATO_POWER3_REPEAT;
        });
        this.comboAnimation.put(StarAnimations.YAMATO_POWER3_REPEAT.getRegistryName(), () -> {
            return (AttackAnimation)StarAnimations.YAMATO_POWER3_REPEAT;
        });
        this.comboAnimation.put(StarAnimations.YAMATO_DASH.getRegistryName(), () -> {
        ...
        listener.addEventListener(EventType.ATTACK_ANIMATION_END_EVENT, EVENT_UUID, (event) -> {
            ...
            if (id != StarAnimations.YAMATO_POWER3.getId() && id != StarAnimations.YAMATO_POWER3_REPEAT.getId()) {
                ...
                if (id == StarAnimations.YAMATO_STRIKE2.getId()) {
                    ((ServerPlayerPatch)event.getPlayerPatch()).reserveAnimation(StarAnimations.YAMATO_AUTO4);
                }
            } else {
